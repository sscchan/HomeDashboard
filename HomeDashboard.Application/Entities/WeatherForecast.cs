...
public class WeatherForecast
{
    ...
    public WeatherForecast(DateTime dateTime, string weatherDescription, float rainProbabilityPercentage, float minimumRainfall, float maximumRainfall, float minimumTemperature, float maximumTemperature)
    {
        DateTime = dateTime;
